...
def main():
  ...
  # Read building.csv
  buildings = None
  with open('input/building.csv', 'r', encoding='UTF-8') as file:
  ...
  # Read college.csv
  colleges = None
  with open('input/college.csv', 'r', encoding='UTF-8') as file:
    reader = CsvReader(file)
  ...
  day_of_weeks = None
  with open('input/day_of_week.csv', 'r', encoding='UTF-8') as file:
    reader = CsvReader(file)
  ...
  lecturerooms = None
  with open('input/lectureroom.csv', 'r', encoding='UTF-8') as file:
    reader = CsvReader(file)
  ...
  # Read semester.csv
  semesters = None
  with open('input/semester.csv', 'r', encoding='UTF-8') as file:
    reader = CsvReader(file)
  ...
  # Read timetable.csv
  timetables = None
  with open('input/timetable.csv', 'r', encoding='UTF-8') as file:
    reader = CsvReader(file)
  ...
  with open(options.output_file, 'w+', encoding='UTF-8') as sql_file:
    # Faculty Table
